    ...
    <main id="top">
      <section className="hero-section">
        ...
        <div className="site-container hero-inner">
          ...
          <div className="hero-image reveal" style={{ transitionDelay: '100ms' } as CSSProperties}><div className="image-label"><span>REAL PRODUCT</span><span>NOATUN / PHOTOS</span></div><ProductWindow label="PHOTOS" className="hero-product-window"><div className="hero-shot"><img src={asset(theme === 'light' ? '07-photos-light-list.png' : '04-photos.png')} alt="Noatun Photos interface showing a private photo library" /></div></ProductWindow><div className="image-caption">The interface is real. The infrastructure is yours.</div></div>
        </div>
      </section>
      ...
      <section className="quote-section"><div className="site-container quote-grid"><div className="quote-mark">↗</div><blockquote>Your server should feel like a product.</blockquote><div className="quote-aside"><span className="eyebrow">THE NOATUN PROMISE</span><p>Clear ownership. Visible operations. A workspace people actually want to use.</p></div></div></section>
