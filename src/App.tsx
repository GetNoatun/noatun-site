  ...
  return <div className="site-shell">
    <header className="site-header">
      <div className="site-container header-inner">
        ...
        <nav className="desktop-nav" aria-label="Main navigation"><a href="#product">Product</a><a href="/enterprise/">For teams ↗</a><a href="#faq">FAQ</a></nav>
      ...
      {mobileNav && <nav className="mobile-nav"><a href="#product" onClick={() => setMobileNav(false)}>Product</a><a href="/enterprise/" onClick={() => setMobileNav(false)}>For teams ↗</a><a href="#faq" onClick={() => setMobileNav(false)}>FAQ</a><a className="button button-dark" href="#waitlist" onClick={() => setMobileNav(false)}>Get early access</a></nav>}
    </header>
    ...
    <footer className="site-footer"><div className="site-container footer-inner"><div>© {new Date().getFullYear()} Noatun · Private personal cloud.</div><div className="footer-links"><a href="/enterprise/">For teams ↗</a><a href="mailto:hello@noatun.app">hello@noatun.app</a></div></div></footer>
  </div>
}
